...
router.get('/create', function(req, res, next) {
  res.render('projectform', {title: 'Create New Project', style: "newevent"})
})
...
router.get('/modify/:project_id', function(req, res, next) {
  ...
  // }
  //alternatively
  let project = projects_data.find(function(prj){ return prj.project_id == project_id});
  if (project === undefined ){
    next(); //pass along, send 404
  }
  else {
    res.render('projectform', { title: 'Modify Project', style: "newevent", project: project});
  }
